 ...
 */
  ...
  broadcastServerSystemInfo: function (msg) {
    ...
    SysLog.console('Server SYSTEM to ' + clients + ' clients: ' + msg);
  },
  ...
  broadcastServerRegularInfo: function (msg) {
    ...
    SysLog.console( 'Server INFO to ' + clients + ' clients: ' + msg );
  },
 ...
 */
  ...
  broadcastPeerRegularInfo: function (msg) {
    ...
    SysLog.console( 'Client REGULAR to ' + clients + ' clients: ' + msg );
  },
  ...
  broadcastPeerPrivateInfo: function (msg, list) {
    ...
    SysLog.console( 'Client PRIVATE to ' + clients + ' clients: ' + msg );
  },
