...
HttpControl.prototype = {
  ...
  handleHttpRequest: function (request, response) {
    ...
    var debug = request.headers.origin + ' used request method: ' + request.method;
    ...
    if (request.method === 'OPTIONS'){
        ...
        SysLog.console( debug + 'Responded with server CORS rules.' );
    ...
    if (request.method === 'GET') {
        ...
        request.on('end', function() {
            ...
            SysLog.console(serverStats);
            SysLog.console( debug + 'Responded with server meta data.' );
